...
class BlockIntersectionChecker:
    def __init__(self):
        ...
        self.sub_assemblies = []
        self.bb = None
        self.approach_directions = [(-1, "negative x"), (1, "positive x"), (-1,
                                                                            "negative y"), (1, "positive y"), (-1, "negative z"), (1, "positive z")]
    ...
    def check_intersection(self):
        ...
        for i, direction in self.approach_directions:
            ...
            self.sub_assemblies[0] = BRepAlgoAPI_Fuse(
                self.sub_assemblies[0], self.sub_assemblies[i]).Shape()
    ...
    def check_positive_y(self, bb1):
        for j in range(math.floor(bb1[3]), math.ceil(self.bb1[2]), 1):
            ...
            inter = self.intersect_shape_by_line(
                self.sub_assemblies[0], my_line)
...
if __name__ == '__main__':
    ...
    checker.run("final_assembly.stp")
